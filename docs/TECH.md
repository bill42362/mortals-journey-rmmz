...
| **中文字型內嵌** | **打包開源 CJK 字型**（建議思源黑體 / Noto Sans CJK TC，SIL OFL 授權，可商用可散布）🔴 未做 | 網頁部署預設字型不保證涵蓋全中文 → 某些瀏覽器出「豆腐方塊」；與 i18n 逐語言字型綁一起做 | 字型檔入 `game/fonts/`、`gamefont.css`/MessageCore 設定 |
